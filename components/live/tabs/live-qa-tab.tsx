  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="scrollbar-thin flex max-h-64 flex-col gap-2 overflow-y-auto">
        {questions.length === 0 && <p className="text-white/60">No questions yet — be the first to ask.</p>}
        {questions.map((q) => (
      ...
      <form onSubmit={handleAsk} className="flex items-center gap-2">
        <input
          ...
          placeholder={isLoggedIn ? 'Ask the panel a question…' : 'Log in to ask a question…'}
